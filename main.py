...
"""
    ...
    counter = 1
    file_name = r'generation\data.polyethylene1'
    flag = True
    while flag:
        if exists(file_name):
            counter += 1
            file_name = r'generation\data.polyethylene{}'.format(counter)
        else:
            flag = False
...
for i in range(repeats):
    ...
    print (generate)
    relaxation(generate[0], generate[1]) #Perform geometry optimisation on the polyethylene chain generated by main.
