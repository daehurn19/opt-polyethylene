...
"""
    ...
    counter = 1
    file_name = r'C:\Users\daehu\OneDrive\Desktop\polyethylene\Poly_data\data.polyethylene1'
    flag = True
    while flag:
        if exists(file_name):
            counter += 1
            file_name = r'C:\Users\daehu\OneDrive\Desktop\polyethylene\Poly_data\data.polyethylene{}'.format(counter)
        else:
            flag = False
...
for i in range(repeats):
    ...
    relaxation(generate) #Perform geometry optimisation on the polyethylene chain generated by main.
